...
var Particles = {
    ...
    Electron:       {mass: 0.5, charge:  1, lifetime:2000, size:10, color: "blue" , leavesTrack: true, leavesEnergy: true},
    Positron:       {mass: 0.5, charge: -1, lifetime:2000, size:10, color: "blue" , leavesTrack: true, leavesEnergy: true},
    Proton:         {mass: 0.5, charge:  1, lifetime:2000, size:10, color: "red"  , leavesTrack: true, leavesEnergy: true},
    Antiproton:     {mass: 0.5, charge: -1, lifetime:2000, size:10, color: "red"  , leavesTrack: true, leavesEnergy: true},
    Neutron:        {mass: 0.5, charge:  0, lifetime:2000, size:10, color: "grey" , leavesTrack: false, leavesEnergy: true},
    Antineutron:    {mass: 0.5, charge:  0, lifetime:2000, size:10, color: "grey" , leavesTrack: false, leavesEnergy: true},
    ...
    Muon:           {mass: 0.5, charge:  1, lifetime:2000, size:10, color: Qt.darker("blue"), leavesTrack: true, leavesEnergy: false},
    Antimuon:       {mass: 0.5, charge: -1, lifetime:2000, size:10, color: Qt.darker("blue"), leavesTrack: true, leavesEnergy: false}
    }
